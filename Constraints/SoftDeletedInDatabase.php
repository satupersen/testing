...
namespace Satupersen\Testing\Constraints;

use Satupersen\Database\Connection;
...
class SoftDeletedInDatabase extends Constraint
{
     ...
     *
     * @var \Satupersen\Database\Connection
     */
    protected $database;
     ...
     *
     * @param  \Satupersen\Database\Connection  $database
     * @param  array  $data
