...
namespace Satupersen\Testing;

use ArrayAccess;
use Closure;
use Satupersen\Contracts\View\View;
use Satupersen\Database\Eloquent\Model;
use Satupersen\Support\Arr;
use Satupersen\Support\Carbon;
use Satupersen\Support\Str;
use Satupersen\Support\Traits\Macroable;
use Satupersen\Support\Traits\Tappable;
use Satupersen\Testing\Assert as PHPUnit;
use Satupersen\Testing\Constraints\SeeInOrder;
use LogicException;
use Symfony\Component\HttpFoundation\StreamedResponse;

/**
 * @mixin \Satupersen\Http\Response
 */
class TestResponse implements ArrayAccess
{
     ...
     *
     * @param  \Satupersen\Http\Response  $response
     * @return void
     */
     ...
     *
     * @return \Satupersen\Session\Store
     */
